...
- Desktop sessions MAY **create** new files and register them as artifacts via Filesystem MCP + `seldon cc register` or `seldon artifact create`. Creation ≠ mutation — a new file has no prior state to corrupt.
